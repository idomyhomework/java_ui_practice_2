...
public class Ejercicio6 extends JFrame {
    ...
    public Ejercicio6() {
        ...
        panelCentral.add(new JLabel("Elija una opción para ver la imagen", SwingConstants.CENTER), BorderLayout.NORTH);
        ...
        panelSalir.setBorder(BorderFactory.createEmptyBorder(5, 5, 10, 5));
    ...
    void mostrarImagen(String animal) {
        String ruta = switch (animal) {
            ...
            default -> "/images/animales/leon.jpg";
        };
